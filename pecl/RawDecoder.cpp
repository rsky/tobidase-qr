// This RawDecoder.cpp is a subset of Decoder.cpp
/*
 *  Decoder.cpp
 *  zxing
 *
...
void RawDecoder::correctErrors(ArrayRef<unsigned char> codewordBytes, int numDataCodewords) {
...
Ref<RawDecodedResult> RawDecoder::decode(Ref<BitMatrix> bits) {
  ...
  return Ref<RawDecodedResult>(new RawDecodedResult(resultBytes, ecLevel, version));
}
